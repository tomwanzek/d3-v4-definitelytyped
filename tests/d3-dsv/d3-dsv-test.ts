...
import * as d3Dsv from '../../src/d3-dsv';
...
parseRowsMappedArray = d3Dsv.csvParseRows(csvTestStringWithHeader, function (rawRow, index) {
...
parseRowsMappedArray = d3Dsv.tsvParseRows(tsvTestStringWithHeader, function (rawRow, index) {
    let rr: Array<string> = rawRow;
    let i: number = index;
    let pr: ParsedTestObject;
